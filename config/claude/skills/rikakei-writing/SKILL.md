...
description: 木下是雄『理科系の作文技術』に基づき、明快で簡潔かつ論理的な日本語を書くためのスキル。ユーザーが `rikakei-writing`、`$rikakei-writing`、またはこのスキルの使用を明示的に指定した場合にのみ使用する。日本語文書の作成、推敲、レビューという理由だけでは使用しない。
---
